...
namespace EmpresaTVxCable.Controllers
{
    public class ServiciosController : Controller
    {
        ...
        public ServiciosController(BdTvXcableContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("IdServicio,Nombre,Precio")] Servicio servicio)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdServicio,Nombre,Precio")] Servicio servicio)
        {
